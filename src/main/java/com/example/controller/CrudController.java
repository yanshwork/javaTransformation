...
public class CrudController {
    ...
    @GetMapping("/products/image") // Changed to GET
    public ResponseEntity<byte[]> getProductImage(@RequestParam long productId) { // Changed to @RequestParam
        ...
        if (product == null) {
            ...
            try {
                ...
                return new ResponseEntity<>(image, HttpStatus.OK); // Changed status to OK
